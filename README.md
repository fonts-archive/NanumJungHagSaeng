...
사용하는 `font-family`의 이름은 `NanumJungHagSaeng`입니다.

### HTML

```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/NanumJungHagSaeng/NanumJungHagSaeng.css" type="text/css"/>
```

### CSS `@Import`

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/NanumJungHagSaeng/NanumJungHagSaeng.css');
```
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/NanumJungHagSaeng/subsets/NanumJungHagSaeng-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url("https://cdn.jsdelivr.net/gh/fonts-archive/NanumJungHagSaeng/subsets/NanumJungHagSaeng-dynamic-subset.css");
```
...
```css
font-family: "NanumJungHagSaeng", -apple-system, BlinkMacSystemFont, "Segoe UI",Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
